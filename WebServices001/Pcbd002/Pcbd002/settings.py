...
SECRET_KEY = 'v@61wqd9=9dkf!=ffbf3xg--cv@(1zv1q@5h-lt)-i1agr91dl'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = []
ALLOWED_HOSTS.insert(0,outcmd.decode().rstrip())
...
WSGI_APPLICATION = 'Pcbd002.wsgi.application'
